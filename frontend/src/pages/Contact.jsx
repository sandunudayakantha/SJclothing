...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/settings/contact', formData)
            ...
            {settings?.contact?.phone && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${settings.contact.phone}`} className="text-gray-600 hover:text-accent">
                    {settings.contact.phone}
                  </a>
                </div>
              </div>
            ...
            {settings?.contact?.email && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${settings.contact.email}`} className="text-gray-600 hover:text-accent">
                    {settings.contact.email}
                  </a>
                </div>
              </div>
